...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://ws.mkyong.com/", "getHelloWorldAsStringResponse");
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://ws.mkyong.com/", "getHelloWorldAsString");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.mkyong.com/", name = "getHelloWorldAsStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.mkyong.com/", name = "getHelloWorldAsString")
