...
* Componente Log: para pintar en pantalla los pasos por donde va pasando la ruta.
* Componente Timer: para ir ejecutando una accion cada cierto tiempo.
...
``` 
$  osgi:install -s mvn:org.jboss.quickstarts.fuse/fuse-camel-blueprint-log-timer/1.0.0-SNAPSHOT
...
$ osgi:uninstall -s mvn:org.jboss.quickstarts.fuse/fuse-camel-blueprint-log-timer/1.0.0-SNAPSHOT
